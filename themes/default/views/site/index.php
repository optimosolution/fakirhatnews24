		...
		<div class="row alert alert-success">
			...
			<div class="col-md-10">
				<marquee behavior="scroll" onmouseover="this.stop()"
					onmouseout="this.start()"><?php $this->get_marquee_news(9); ?></marquee>
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-md-3">
                ...
                <div class="btn-group btn-block">
					<button type="button"
						...
						data-toggle="dropdown"><?php echo ContentCategory::getCategoryName(10); ?> <span class="caret"></span>
					</button>
					<ul class="dropdown-menu" role="menu">
                				<?php
									$array = ContentCategory::model ()->findAll ( array (
											'condition' => 'published=1 AND parent_id=10',
											'order' => 'title ASC, created_time DESC' 
									) );
									foreach ( $array as $key => $value ) {
										echo '<li>' . CHtml::link ( '<i class="fa fa-external-link"></i> ' . $value ['title'], array (
												'content/upozila',
												'id' => $value ['id'] 
										), array () ) . '</li>';
									}
		...
		<div class="row">
			...
			<div class="col-md-4">
				<h3 class="section-title">
					<i class="fa fa-facebook"></i> Facebook Like Box
				</h3>
                <?php
